...
Вероятно certbot будет ругаться, что 80 порт занят, тогда останови sudo systemctl stop AdGuardHome затем заново введи команду для установки сертификата, после успешного выпуска запусти снова sudo systemctl start AdGuardHome
